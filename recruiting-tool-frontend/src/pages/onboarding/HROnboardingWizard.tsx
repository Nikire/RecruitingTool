...
import { useHROnboardingStatus, useCompleteHROnboarding, CompleteHROnboardingData } from '../../hooks/api/useOnboarding';
...
const HROnboardingWizard: React.FC = () => {
	...
	const { data: onboardingStatus, isLoading: isLoadingStatus } = useHROnboardingStatus();
	...
	const steps = [t('hr_onboarding.steps.welcome'), t('hr_onboarding.steps.profile_setup'), t('hr_onboarding.steps.complete')];
	...
	return (
		<Box sx={{ minHeight: '60vh', py: 4, px: 2 }}>
			<Paper elevation={3} sx={{ p: { xs: 2, sm: 3, md: 4 }, maxWidth: 800, mx: 'auto' }}>
				...
				{activeStep === 1 && (
					<form onSubmit={handleSubmit(onSubmit)}>
						...
						<TextField
							...
							helperText={errors.position?.message || t('hr_onboarding.profile_setup.position_helper')}
						/>
						...
						<TextField
							...
							helperText={errors.department?.message || t('hr_onboarding.profile_setup.department_helper')}
						/>
						...
						<TextField
							...
							helperText={errors.phoneNumber?.message || t('hr_onboarding.profile_setup.phone_helper')}
						/>
						...
						<TextField
							...
							helperText={errors.timezone?.message || t('hr_onboarding.profile_setup.timezone_helper')}
						/>
						...
						<TextField
							...
							error={!!errors.bio}
							helperText={errors.bio?.message || t('hr_onboarding.profile_setup.bio_helper')}
						/>
