...
const PlanSelectionStep: React.FC<PlanSelectionStepProps> = ({ selectedPlan, onNext }) => {
	...
	const plans: PlanCard[] = [
		{
			...
			color: 'default',
			features: [
				{ key: 'onboarding.plans.features.basic_candidate_management', included: true },
				...
				{ key: 'onboarding.plans.features.email_notifications', included: true },
				{ key: 'onboarding.plans.features.ai_resume_screening', included: false },
				{ key: 'onboarding.plans.features.advanced_analytics', included: false },
		...
		},
		{
			...
			features: [
				...
				{ key: 'onboarding.plans.features.unlimited_candidates', included: true },
				{ key: 'onboarding.plans.features.ai_resume_screening', included: true },
				{ key: 'onboarding.plans.features.advanced_analytics', included: true },
				{ key: 'onboarding.plans.features.custom_email_templates', included: true },
				{ key: 'onboarding.plans.features.priority_support', included: true },
				{ key: 'onboarding.plans.features.calendar_integration', included: true },
			],
		},
		{
			...
			color: 'secondary',
			features: [
				{ key: 'onboarding.plans.features.everything_in_professional', included: true },
				{ key: 'onboarding.plans.features.unlimited_users', included: true },
				{ key: 'onboarding.plans.features.dedicated_account_manager', included: true },
				{ key: 'onboarding.plans.features.custom_integrations', included: true },
	...
	return (
		<Box>
			...
			<Grid container spacing={3} justifyContent="center">
				{plans.map((planCard) => (
					<Grid item xs={12} sm={6} md={4} key={planCard.plan} sx={{ overflow: 'visible' }}>
						<Card
						...
						>
							...
							<CardContent sx={{ flexGrow: 1, pt: planCard.recommended ? 4 : 3 }}>
