	...
	const features = [
		{
			...
			descriptionKey: 'onboarding.welcome.features.candidate_management.description',
		},
		{
		...
		},
		{
			...
			descriptionKey: 'onboarding.welcome.features.interview_scheduling.description',
		},
	];
	...
	return (
		<Box>
			...
			<Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
				<Button variant="contained" size="large" onClick={onComplete} sx={{ px: 6, py: 1.5 }}>
