...
const ErrorBoundaryTest = () => {
  ...
  if (shouldThrowError) {
    ...
    throw new Error(
      "This is a test error thrown intentionally to verify ErrorBoundary works correctly.",
    );
  }
    ...
    <Container maxWidth="md" sx={{ mt: 8, mb: 4 }}>
      ...
      >
        ...
        <Typography
          ...
          sx={{ mb: 4 }}
        >
          This page is for testing the ErrorBoundary component. Clicking the
          button below will intentionally throw an error to verify that the
          ErrorBoundary catches it and displays the fallback UI correctly.
        </Typography>
        ...
        >
          ...
          <Typography variant="body2" component="div">
            <ol>
              ...
              <li>
                Verify the ErrorBoundary displays a user-friendly error page
              </li>
              <li>Check that "Reload Page" and "Go Home" buttons work</li>
              <li>
                In development mode, verify error details accordion is visible
              </li>
