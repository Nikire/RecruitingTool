...
const ConfirmationStep: React.FC<ConfirmationStepProps> = ({ formData, onComplete, onBack }) => {
	...
	return (
		<Box>
			...
			<Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 4 }}>
				...
				>
					{isPending ? t('registration_wizard.confirmation.creating_account') : t('common.finish')}
				</Button>
			</Box>
		</Box>
	);
