		...
		>
			...
			<Stack spacing={3}>
				...
				<FormControl fullWidth size="small">
					...
					<Select
						value={company}
						onChange={(e: SelectChangeEvent) => onFilterChange('company', e.target.value)}
				...
				<FormControl fullWidth size="small">
					...
					<Select
						value={category}
						onChange={(e: SelectChangeEvent) => onFilterChange('category', e.target.value)}
				...
				<FormControl fullWidth size="small">
					...
					<Select
						value={jobType}
						onChange={(e: SelectChangeEvent) => onFilterChange('jobType', e.target.value)}
				...
				<FormControl fullWidth size="small">
					...
					<Select
						value={workLocation}
						onChange={(e: SelectChangeEvent) => onFilterChange('workLocation', e.target.value)}
				...
				<FormControl fullWidth size="small">
					...
					<Select
						...
						onChange={(e: SelectChangeEvent) => onFilterChange('experienceLevel', e.target.value)}
