...
describe("AccessDeniedMessage", () => {
  describe("Rendering", () => {
    ...
    it("should display custom message when provided", () => {
      renderWithProviders(
        <AccessDeniedMessage message="Custom access denied message" />,
      );
    ...
    it("should display required roles when provided", () => {
      renderWithProviders(
        <AccessDeniedMessage requiredRoles={["ADMIN", "HR"]} />,
      );
    ...
    it("should format multiple roles correctly", () => {
      renderWithProviders(
        <AccessDeniedMessage requiredRoles={["ADMIN", "HR", "RECRUITER"]} />,
      );
