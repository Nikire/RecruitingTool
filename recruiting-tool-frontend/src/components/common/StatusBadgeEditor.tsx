...
import {Box, Chip, Menu, MenuItem, Typography, ListItemIcon, ListItemText} from '@mui/material';
		...
		<Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
			...
			>
				...
				{statusOptions.map((option) => (
					...
					>
						<ListItemIcon>{option.icon || DEFAULT_ICONS[option.value]}</ListItemIcon>
						<ListItemText>
							<Chip label={t(option.labelKey)} color={option.color} size="small" />
						</ListItemText>
					</MenuItem>
				))}
			</Menu>
