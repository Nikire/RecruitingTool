...
describe('StatusChip', () => {
  describe('Rendering', () => {
    ...
    it('should render as small size by default', () => {
      const { container } = renderWithProviders(<StatusChip status="OPEN" type="jobPosition" />);
    ...
    it('should render as filled variant by default', () => {
      const { container } = renderWithProviders(<StatusChip status="PENDING" type="application" />);
  ...
  describe('Application Status Colors', () => {
    ...
    it('should apply primary color for REVIEWED status', () => {
      renderWithProviders(
        <StatusChip status="REVIEWED" type="application" />
      );
  ...
  describe('Job Position Status Colors', () => {
    ...
    it('should apply default color for CLOSED status', () => {
      const { container } = renderWithProviders(<StatusChip status="CLOSED" type="jobPosition" />);
  ...
  describe('Translation', () => {
    it('should display raw status when translate is false', () => {
      renderWithProviders(<StatusChip status="PENDING" type="application" translate={false} />);
    ...
    it('should translate status when translate is true', () => {
      ...
      renderWithProviders(
        <StatusChip status="PENDING" type="application" translate={true} translationPrefix="status." />
      );
