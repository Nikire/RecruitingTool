...
describe('ActionsCell', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render all buttons when all callbacks provided', () => {
      renderWithProviders(
        <ActionsCell onView={mockOnView} onEdit={mockOnEdit} onDelete={mockOnDelete} />
      );
    ...
    it('should not render view button when onView not provided', () => {
      renderWithProviders(<ActionsCell onEdit={mockOnEdit} onDelete={mockOnDelete} />);

      expect(screen.queryByLabelText(/view/i)).not.toBeInTheDocument();
    });

    it('should not render edit button when onEdit not provided', () => {
      renderWithProviders(<ActionsCell onView={mockOnView} onDelete={mockOnDelete} />);

      expect(screen.queryByLabelText(/edit/i)).not.toBeInTheDocument();
    });

    it('should not render delete button when onDelete not provided', () => {
      renderWithProviders(<ActionsCell onView={mockOnView} onEdit={mockOnEdit} />);
  ...
  describe('Show/Hide Props', () => {
    ...
    it('should hide delete button when showDelete is false', () => {
      renderWithProviders(<ActionsCell onDelete={mockOnDelete} showDelete={false} />);
  ...
  describe('Button Sizing', () => {
    it('should render small buttons by default', () => {
      const { container } = renderWithProviders(<ActionsCell onEdit={mockOnEdit} />);
    ...
    it('should render medium buttons when size is medium', () => {
      const { container } = renderWithProviders(<ActionsCell onEdit={mockOnEdit} size="medium" />);
  ...
  describe('Button Colors', () => {
    it('should render view button with primary color', () => {
      const { container } = renderWithProviders(<ActionsCell onView={mockOnView} />);

      const primaryButton = container.querySelector('.MuiIconButton-colorPrimary');
    ...
    it('should render delete button with error color', () => {
      const { container } = renderWithProviders(<ActionsCell onDelete={mockOnDelete} />);
