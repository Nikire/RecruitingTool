...
describe("DateCell", () => {
  ...
  describe("Date Formatting", () => {
    ...
    it("should use custom format string", () => {
      renderWithProviders(
        <DateCell value={validDate} formatString="yyyy-MM-dd" />,
      );
  ...
  describe("Relative Time", () => {
    it("should show relative time when relative is true", () => {
      ...
      renderWithProviders(
        <DateCell value={recentDate.toISOString()} relative />,
      );
  ...
  describe("Format String Variations", () => {
    it("should support full month name format", () => {
      renderWithProviders(
        <DateCell value={validDate} formatString="MMMM dd, yyyy" />,
      );
    ...
    it("should support numeric date format", () => {
      renderWithProviders(
        <DateCell value={validDate} formatString="MM/dd/yyyy" />,
      );
    ...
    it("should support ISO format", () => {
      renderWithProviders(
        <DateCell value={validDate} formatString="yyyy-MM-dd'T'HH:mm:ss" />,
      );
