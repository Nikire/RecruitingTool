...
describe('Pagination', () => {
  ...
  describe('Rendering', () => {
    it('should render pagination controls', () => {
      ...
      renderWithProviders(
        <Pagination meta={meta} onPageChange={mockOnPageChange} onLimitChange={mockOnLimitChange} />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle large page numbers', () => {
      ...
      expect(screen.getByText(/showing 981 to 990 of 1000/i)).toBeInTheDocument();
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('should have aria-label for pagination navigation', () => {
      ...
      expect(screen.getByLabelText(/pagination navigation/i)).toBeInTheDocument();
    });
