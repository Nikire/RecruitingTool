...
test.describe('Subscription Management', () => {
  ...
  test('should display current subscription plan', async ({ page }) => {
    ...
    const planInfo = page.locator('text=/plan|subscription|suscripción/i').first();
  ...
  test('should display billing information', async ({ page }) => {
    ...
    const billingInfo = page.locator('text=/billing|payment|facturación|pago/i').first();
  ...
  test('should show subscription status', async ({ page }) => {
    ...
    const statusIndicators = page.locator('text=/active|trial|expired|activo|prueba|expirado/i, .MuiChip-root');
  ...
  test('should display pricing information', async ({ page }) => {
    ...
    const priceInfo = page.locator('text=/\\$/i, text=/€/i, text=/price|precio/i').first();
