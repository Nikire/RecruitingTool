...
test.describe('Analytics Dashboard', () => {
  ...
  test('should display analytics charts or graphs', async ({ page }) => {
    ...
    const hasEmptyState = await page.locator('text=/no.*data|coming.*soon|sin.*datos/i').count() > 0;
  ...
  test('should have date range selector', async ({ page }) => {
    ...
    const dateSelector = page.locator('button, input').filter({
  ...
  test('should display hiring funnel metrics', async ({ page }) => {
    ...
    const funnelMetrics = page.locator('text=/funnel|pipeline|conversion|embudo|conversión/i').first();
  ...
  test('should show time to hire statistics', async ({ page }) => {
    ...
    const timeMetrics = page.locator('text=/time.*to.*hire|average.*time|tiempo.*promedio/i').first();
  ...
  test('should display application source analytics', async ({ page }) => {
    ...
    const sourceAnalytics = page.locator('text=/source|channel|referral|origen|canal/i').first();
  ...
  test('should display position performance metrics', async ({ page }) => {
    ...
    const positionMetrics = page.locator('text=/position|job.*performance|rendimiento.*puesto/i').first();
  ...
  test('should show interviewer statistics', async ({ page }) => {
    ...
    const interviewerStats = page.locator('text=/interviewer|interview.*activity|entrevistador|actividad.*entrevista/i').first();
