...
test.describe('User Profile Management', () => {
  ...
  test('should display user information', async ({ page }) => {
    ...
    const userName = page.locator('text=/Alice Johnson|Alice|Johnson/i').first();
  ...
  test('should display email address', async ({ page }) => {
    ...
    const email = page.locator('text=/alice@techinnovations.com|email|correo/i').first();
  ...
  test('should have password change option', async ({ page }) => {
    ...
    const passwordButton = page.locator('button, a').filter({
  ...
  test('should navigate to subscription page', async ({ page }) => {
    ...
    const subscriptionLink = page.locator('button, a').filter({
  ...
  test('should display company information', async ({ page }) => {
    ...
    const companyInfo = page.locator('text=/company|Tech Innovations|empresa/i').first();
  ...
  test('should have notification preferences', async ({ page }) => {
    ...
    const notificationSettings = page.locator('text=/notification|notificación|alert|alerta/i').first();
