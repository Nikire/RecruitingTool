...
export const emailBaseStyles = {
  ...
  table: 'border-collapse: collapse; width: 100%; max-width: 500px; margin: 20px 0;',
  tableCell: 'padding: 12px; border: 1px solid #e0e0e0;',
  tableCellBold: 'padding: 12px; border: 1px solid #e0e0e0; font-weight: bold; background-color: #f5f5f5;',
