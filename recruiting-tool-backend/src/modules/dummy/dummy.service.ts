...
export class DummyService implements OnApplicationBootstrap {
  ...
  private getStageProgressionDate(startDate: Date, stageIndex: number, _totalStages?: number): Date {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  private shouldCandidateProgressToStage(stageIndex: number, _totalStages?: number): boolean {
