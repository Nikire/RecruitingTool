...
export class NotificationPreferencesService {
  ...
  async getPreferences(
    ...
    if (!preferences) {
      this.logger.log(
        `No preferences found for user ${userUid}, creating defaults`,
      );
      preferences =
        await this.databaseService.notificationPreference.create({
          data: {
            userId: user.id,
  ...
  async updatePreferences(
    ...
    if (!user.notificationPreferences) {
      this.logger.log(
        `No preferences found for user ${userUid}, creating with provided values`,
      );
    ...
    const updatedPreferences =
      await this.databaseService.notificationPreference.update({
